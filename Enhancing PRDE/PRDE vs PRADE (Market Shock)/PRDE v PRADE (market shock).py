...
mid_time = end_time / 2  # Calculating the half way point for a market shock
wait_time = 7200  # each strategy gets evaluated for 7200 seconds (2hrs) each -> whole set K takes 8hrs before mutation

# Defining the supply and demand schedule as symmetric with arbitrary range and market shock and mid point
range_one = (50, 150)
range_two = (200, 300)

stepmode = "fixed"
supply_schedule = [{"from": start_time, "to": mid_time, "ranges": [range_one], "stepmode": stepmode},
                   {"from": mid_time, "to": end_time, "ranges": [range_two], "stepmode": stepmode}]
...
trial_id = "PRADE_v_PRDE_mkt_shk_"
