...
The code for Trader PRADE2 (i.e. current-to-ran/1 PRADE is written directly into BSE.
"""
...
wait_time = 7200  # each strategy gets evaluated for 7200 seconds (2hrs) each
...
PRADE2_trader_params = PRADE_trader_params
sellers_spec = [("PRADE2", 15, PRADE2_trader_params), ("PRADE", 15, PRADE_trader_params)]
seller_num = 30
...
trial_id = "rand-1_v_current-to-rand-1_"
